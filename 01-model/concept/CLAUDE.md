...
- Do not run any commands that modify files or make network requests outside the claude CLI
- Record observations in the table in README.md — you may edit README.md to fill it in
