# CLAUDE.md — 01-model advanced

- Exercise: 01-model advanced — two-stage triage pipeline
- Allowed tools: Bash, Read, Write
- Focus: build pipeline.sh; measure latency and estimated cost per task
- Use routing-prompt.md from 01-model/intermediate/ as Stage 1 — do not duplicate it
- pipeline.sh goes in 01-model/advanced/
